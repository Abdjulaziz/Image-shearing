...
img_copy2 = np.zeros((rows2,cols2+cols2,3),np.uint8)

img_copy3 = np.zeros((rows3+rows3,cols3,3),np.uint8)

img_copy4 = np.zeros((rows4+rows4,cols4,3),np.uint8)
...
cv2.imwrite('shearY1Back.PNG', img_copy)
cv2.imwrite('shearY2Back.PNG', img_copy2)
cv2.imwrite('shearX1Back.PNG', img_copy3)
cv2.imwrite('shearX2Back.PNG', img_copy4)
